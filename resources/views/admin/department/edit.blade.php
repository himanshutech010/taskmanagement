...
<div class="content-wrapper">
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.department.index') }}" class="btn btn-gradient-primary">Back</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Department Form</h4>
                    <form class="forms-sample" method="POST" action="{{ route('admin.department.update', $department->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="btn btn-gradient-success">Update Department</button>
                        <a href="{{ route('admin.department.index') }}" class="btn btn-gradient-danger">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
