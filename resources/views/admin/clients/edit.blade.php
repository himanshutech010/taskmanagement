            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.clients.update', $client->id) }}"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="mobile" class="form-control" type="text" name="mobile"
                                        value="{{ old('mobile', $client->mobile) }}" placeholder="Enter Mobile Number">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="skype" class="form-control" type="text" name="skype"
                                        value="{{ old('skype', $client->skype) }}" placeholder="Enter Skype ID">
                                    @if ($errors->has('skype'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="other" class="form-control" type="text" name="other"
                                        value="{{ old('other', $client->other) }}" placeholder="Enter Other Contact">
                                    @if ($errors->has('other'))
