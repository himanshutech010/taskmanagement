            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.clients.store') }}"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="linkedin" class="form-control" type="url" name="linkedin"
                                        value="{{ old('linkedin') }}" placeholder="Enter LinkedIn Profile URL">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="skype" class="form-control" type="text" name="skype"
                                        value="{{ old('skype') }}" placeholder="Enter Skype ID">
                                    @if ($errors->has('skype'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="other" class="form-control" type="text" name="other"
                                        value="{{ old('other') }}" placeholder="Enter Other Contact">
                                    @if ($errors->has('other'))
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="location" class="form-control" name="location" rows="3"
                                        placeholder="Enter Location">{{ old('location') }}</input>
