<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ route('admin.dashboard.index') }}">
            <h1 class="m-0 display-5 font-weight-semi-bold border border-white"><span
                    class="text-primary font-weight-bold border px-3 mr-1">PMS</span>Brain Technosys</h1>
        </a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('admin.dashboard.index') }}">
            <h1 class="m-0 display-5 font-weight-semi-bold border border-white"><span
                    class="text-primary font-weight-bold border px-3 mr-1">PMS</span></h1>
        </a>
    </div>
            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="nav-profile-img">
                        ...
                        <img src="{{ auth()->user()->image ? asset('public/admin/images/profile/' . auth()->user()->image) : asset('public/admin/images/profile/default.jpg') }}"
                ...
                <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                        ...
                        <form action="{{ route('admin.logout') }}" method="GET">
                            @csrf
                            <button
                                type="submit"style="border: 5px  transparent;background:transparent;">Logout</button>
                        </form>
                    </a>
