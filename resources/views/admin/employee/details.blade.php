<div class="main-profile">
    <div class="profile-card-top">
        ...
        <div class="profile-card-right">
            @if ($employee->image)
                <img src="{{ asset('public/admin/images/profile/' . $employee->image) }}" alt="{{ $employee->name }}"
                    class="profile-image">
            @else
                @if ($employee->gender == 'Female')
                    <img src="{{ asset('public/admin/images/profile/default1.png') }}" alt="default female image"
                        class="profile-image">
                @else
                    <img src="{{ asset('public/admin/images/profile/default.jpg') }}" alt="default male image"
                        class="profile-image">
                @endif
            @endif
        </div>
    ...
    <div class="profile-card-bottom">
        <p><strong>Date of Birth:</strong>
            {{ $employee->date_of_birth ? $employee->date_of_birth->format('d M Y') : 'N/A' }}</p>
