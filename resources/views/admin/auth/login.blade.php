        ...
        <form class="pt-3" method="post" action="{{ route('admin.adminLogin') }}">
            ...
            <div class="form-group">
                <input id="email" type="email" name="email"value="{{ old('email') }}"
                    class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                @if ($errors->has('email'))
            ...
            <div class="my-2 d-flex justify-content-between align-items-center">
                <div class="form-check">
                    <label class="form-check-label ">
                        <input type="checkbox" class="form-check-input" style="border: solid #629a43"> Keep me signed in
                    </label>
                </div>
            ...
            <div class="mt-3 d-flex justify-content-center align-items-center">
                <button class="btn btn-block btn-gradient-success text-center btn-lg font-weight-medium auth-form-btn"
